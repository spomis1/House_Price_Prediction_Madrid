...
c1.title('PREDICCIÓN DE PRECIOS DE VIVIENDAS')
c1.subheader('¿Cuánto cuesta tu próximo hogar? :european_castle:')
c2.image('../Data/LOGO.png', width=200)
...
def main():
    ...
    if st.button("Predecir Precio"):
        ...
        # Agregar el mapa con la marca del código postal
        m = folium.Map(location=[40.4167, -3.70325], zoom_start=12)  # Coordenadas de Madrid

        # Podrías tener un diccionario con las coordenadas de cada código postal o alguna otra forma de obtener las coordenadas.
        # Aquí simplemente estoy usando las coordenadas de Madrid como un ejemplo. Reemplázalo con las coordenadas correctas.
        marker_coordinates = [latitud, -3.70325]  # Reemplaza esto con las coordenadas correctas

        folium.Marker(marker_coordinates, tooltip=f"Código Postal: {codigo_seleccionado}").add_to(m)
        # Renderizar el mapa en Streamlit
        html_string = m._repr_html_()
        components.v1.html(html_string, width=800, height=500)
